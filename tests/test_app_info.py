...
class MobileAppUpdateTests(unittest.TestCase):
    ...
    def test_update_disabled_when_build_not_set(self, mock_settings):
        ...
        mock_settings.MOBILE_LATEST_VERSION = ""
        mock_settings.MOBILE_UPDATE_MESSAGE = ""
        mock_settings.MOBILE_IOS_STORE_URL = ""
        mock_settings.MOBILE_ANDROID_PLAY_STORE_URL = ""
    ...
    def test_update_enabled_with_config(self, mock_settings):
        ...
        self.assertEqual(body["latest_version_plus"], "1.2.0+42")
    ...
    @patch("app.api.app_info.settings")
    def test_version_plus_suffix_overrides_env_build(self, mock_settings):
        mock_settings.MOBILE_LATEST_BUILD_NUMBER = 99
        mock_settings.MOBILE_LATEST_VERSION = "1.0.8+2"
        mock_settings.MOBILE_UPDATE_MESSAGE = ""
        mock_settings.MOBILE_IOS_STORE_URL = ""
        mock_settings.MOBILE_ANDROID_PLAY_STORE_URL = ""
        ...
        body = r.json()
        self.assertTrue(body["enabled"])
        self.assertEqual(body["latest_version"], "1.0.8")
        self.assertEqual(body["latest_build"], 2)
        self.assertEqual(body["latest_version_plus"], "1.0.8+2")

    @patch("app.api.app_info.settings")
    def test_version_only_with_zero_build_enabled(self, mock_settings):
        mock_settings.MOBILE_LATEST_BUILD_NUMBER = 0
        mock_settings.MOBILE_LATEST_VERSION = "1.0.8"
        mock_settings.MOBILE_UPDATE_MESSAGE = ""
        mock_settings.MOBILE_IOS_STORE_URL = ""
        mock_settings.MOBILE_ANDROID_PLAY_STORE_URL = ""
        ...
        self.assertTrue(body["enabled"])
        self.assertEqual(body["latest_version"], "1.0.8")
        self.assertEqual(body["latest_build"], 0)
        self.assertEqual(body["latest_version_plus"], "1.0.8")
